...
export default function TokensByLatestTradePage() {
  const fullText = "Tools/NadFun/GetTokensByLatestTrade";
  ...
  return (
    <main className="flex flex-col min-h-screen bg-black text-green-400 font-mono relative">
      ...
      <div className="absolute top-8 w-full flex justify-center">
        <HeaderTyping text="Tools/NadFun/GetTokensByLatestTrade" className="text-3xl" speed={50} />
      </div>
